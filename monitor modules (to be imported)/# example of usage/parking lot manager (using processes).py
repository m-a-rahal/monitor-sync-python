...
from off_topic_code import Car, run_as_process, state_logger_process, go_to_parent_dir
...
class Clean_car(Car):
    @run_as_process # this is a 'decorator', used to run this method as a process
...
def main():
    ...
    logger = state_logger_process(cars, park, lambda : stop_log) 
    ''' the lambda function here helps lets us pass a local variable to a thread AND have it always updated! (reference pass)
